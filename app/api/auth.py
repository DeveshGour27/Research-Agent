...
from fastapi import Depends, HTTPException, Security, status, Cookie, Request
...
def get_current_user(
    ...
    """FastAPI dependency to authenticate the user via Session Cookie OR X-API-Key."""
    if session_id:
        try:
            return get_current_web_user(request=request, session_id=session_id, db=db)
