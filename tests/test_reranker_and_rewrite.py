...
def test_neural_reranker_with_fake_provider(monkeypatch):
    ...
    monkeypatch.setattr("app.llm.factory.create_model_gateway", lambda cfg: fake)
...
def test_llm_rewrite_and_decompose_with_fake_provider(monkeypatch):
    ...
    monkeypatch.setattr("app.llm.factory.create_model_gateway", lambda cfg: fake_rewrite)
    ...
    monkeypatch.setattr("app.llm.factory.create_model_gateway", lambda cfg: fake_decomp)
